...
class CharacterRecycleViewAdapter(val context: Context, var characters : MutableList<Character>, private val itemClickListener: (Character) -> Unit) : RecyclerView.Adapter<CharacterRecycleViewAdapter.CharacterViewHolder>() {
